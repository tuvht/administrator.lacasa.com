...
(function ($, undefined) {
    ...
    var defaults = {
        ...
        keyPress: false,
        controls: true,
        prevHtml: '<img src="http://shotlancer.com/application/libraries/javascript/js/lightslider-master/lightSlider/img/previous.png" />',
        nextHtml: '<img src="http://shotlancer.com/application/libraries/javascript/js/lightslider-master/lightSlider/img/next.png" />',
        rtl: false,
