...
<form method="post" action="<?php echo base_url().'inactive-supplier'?>" name="form">
    <div class="container">
        ...
        <table id="table-form" class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th width="10%"><a href="?order=sup_name&dir=<?php echo $order_dir;?>">Name</a></th>
                    <th width="5%"><a href="?order=active_product&dir=<?php echo $order_dir;?>">Active products</th>
                    <th width="5%"><a href="?order=inactive_product&dir=<?php echo $order_dir;?>">Inactive products</th>
                    <th width="5%"><a href="?order=outofstock_product&dir=<?php echo $order_dir;?>">Out of stock products</th>
                    <th width="5%"><a href="?order=complete_order&dir=<?php echo $order_dir;?>">Complete orders</th>
                    <th width="5%"><a href="?order=cancelled_order&dir=<?php echo $order_dir;?>">Cancelled orders</th>
                    <th width="10%"><a href="?order=sup_joindate&dir=<?php echo $order_dir;?>">Join date</a></th>
                    <th width="10%"><a href="?order=last_sold&dir=<?php echo $order_dir;?>">Last sold</th>
                </tr>
            </thead>
