...
<form method="post" action="<?php echo base_url().'out-of-stock-product'?>" name="form">
...
?></a>
                    ...
                    <td><a href="<?php echo base_url().'update-stock/'.$product['prod_id'].'/'.$product['prod_supplier_id'];?>" data-toggle="modal" data-target="#myModal<?php echo $product['prod_id'];?>" /><?php echo $product['stock_total'];
?></a></td>
                    <td><?php echo dateFormat($product['prod_upload_date']);?></td>
                </tr>
<?php $i++;?>
                <div class="modal fade" id="myModal<?php echo $product['prod_id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
