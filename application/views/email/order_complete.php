...
<h2>Your order has been completed. Thank you for shopping with us.</h2>
...
<div class="col-lg-6 text-left">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <p class="indent"><b>Delivery date</b>: <?php echo $detail['shipping_info']['order_shipping_shipper_actdate']; ?></p>
    </div>
  </div>
</div>
<?php } ?>
