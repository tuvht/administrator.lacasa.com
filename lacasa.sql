...
CREATE TABLE `order_item` (
  ...
  `order_item_prod_variant_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE `order_return_detail` (
  `order_return_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `order_id` bigint(20) DEFAULT NULL,
  `order_return_date` date DEFAULT NULL,
  `order_return_item_id` int(11) DEFAULT NULL,
  `order_return_item_quantity` int(11) DEFAULT NULL,
  `order_return_item_price` double DEFAULT NULL,
  `order_return_item_discountprice` double DEFAULT NULL,
  `order_return_order_discountrate` double DEFAULT NULL,
  `order_return_item_type` int(11) DEFAULT NULL,
  `order_return_item_reason` mediumtext,
  `order_return_item_status` int(11) DEFAULT NULL,
...
CREATE TABLE `product_variant` (
  ...
  `product_id` bigint(20) DEFAULT NULL,
  `product_variant_supplierinternalid` varchar(200) DEFAULT NULL,
  `product_variant_catfield` int(11) DEFAULT NULL,
  `product_variant_value` varchar(200) DEFAULT NULL,
  `product_variant_price` double DEFAULT NULL,
  `product_variant_image` mediumtext,
  `prdoct_variant_note` mediumtext,
...
INSERT INTO `product_variant` VALUES (1,1,'shirtabc0011',1,'size S',0,'',''),(2,1,'shirtabc0012',1,'size M',0,'',''),(3,1,'shirtabc0013',1,'size L',0,'',''),(4,1,'shirtabc0014',1,'size XL',0,'',''),(5,2,'shoexyz0011',2,'red',650000,'/images/products/variants/2_variant_1.jpg','red is special'),(6,2,'shirtabc0012',2,'blue',660000,'/images/products/variants/2_variant_2.jpg ','blue is special'),(7,2,'shirtabc0013',2,'green',670000,'/images/products/variants/2_variant_3.jpg ','green is special'),(8,2,'shirtabc0014',2,'yellow',680000,'/images/products/variants/2_variant_4.jpg ','yello is special');
...
INSERT INTO `product_warehouse_stock` VALUES (1,1,1,1,10),(2,1,1,2,5),(3,1,2,1,5),(4,1,2,2,6),(5,1,3,2,6),(6,1,4,2,6),(7,2,5,1,10),(8,2,6,2,5),(9,2,7,1,5),(10,2,8,2,6),(11,3,0,1,5),(12,4,0,1,5),(13,5,0,1,5),(14,6,0,1,5),(15,7,0,1,5),(16,8,0,1,5),(17,9,0,1,5),(18,10,0,3,5),(19,11,0,3,5),(20,12,0,3,5),(21,13,0,3,5),(22,14,0,3,5),(23,15,0,3,5),(24,16,0,3,5),(25,17,0,3,5),(26,18,0,3,5),(27,19,0,3,5),(28,20,0,3,5),(29,21,0,3,5);
...
CREATE TABLE `supplier_order_item` (
  ...
  `sup_order_prod_variant_id` bigint(20) DEFAULT NULL,
...
-- Dump completed on 2015-11-28 13:38:52
-- MySQL dump 10.13  Distrib 5.5.46, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: web1_asiantech
-- ------------------------------------------------------
...
LOCK TABLES `order_item` WRITE;
/*!40000 ALTER TABLE `order_item` DISABLE KEYS */;
INSERT INTO `order_item` VALUES (1,1,1,1,500000,500000,0,1,'deliver soon',1),(2,1,2,5,500000,500000,0,1,'deliver soon',3),(3,1,3,0,500000,500000,0,1,'deliver soon',3),(4,2,1,1,500000,500000,0,1,'deliver soon',3),(5,2,2,5,500000,500000,0,1,'deliver soon',3),(6,2,3,0,500000,500000,0,1,'deliver soon',2),(7,3,1,1,500000,500000,0,1,'deliver soon',3),(8,3,2,5,500000,500000,0,1,'deliver soon',2),(9,3,3,0,500000,500000,0,1,'deliver soon',4),(10,4,1,1,500000,500000,0,1,'deliver soon',1),(11,5,2,5,500000,500000,0,1,'deliver soon',1),(12,6,3,0,500000,500000,0,1,'deliver soon',3);
/*!40000 ALTER TABLE `order_item` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `orders` WRITE;
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
INSERT INTO `orders` VALUES (1,'0000-00-00',1,'this is note','Dat Huynh','0937111811','14 phan ton','1','1','1',1,'TR123456','0000-00-00','0000-00-00','0000-00-00',20000,1,6),(2,'0000-00-00',2,'this is note','Tu Vuong','0937111811','15 phan ton','1','1','1',1,'TR123456','0000-00-00','0000-00-00','0000-00-00',30000,1,1),(3,'0000-00-00',3,'this is note','Tai Pham','0937111811','15 phan ton','1','1','1',1,'TR123456','0000-00-00','0000-00-00','0000-00-00',30000,1,1),(4,'0000-00-00',2,'this is note','Tu Vuong','0937111811','15 phan ton','1','1','1',1,'TR123456','0000-00-00','0000-00-00','0000-00-00',30000,1,6),(5,'0000-00-00',2,'this is note','Tu Vuong','0937111811','15 phan ton','1','1','1',1,'TR123456','0000-00-00','0000-00-00','0000-00-00',30000,1,6),(6,'0000-00-00',2,'this is note','Tu Vuong','0937111811','15 phan ton','1','1','1',1,'TR123456','0000-00-00','0000-00-00','0000-00-00',30000,1,6);
/*!40000 ALTER TABLE `orders` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `product_variant` (
  ...
  `product_variant_catfield1` int(11) DEFAULT NULL,
  `product_variant_value1` varchar(200) DEFAULT NULL,
  `product_variant_catfield2` int(11) DEFAULT NULL,
  `product_variant_value2` varchar(200) DEFAULT NULL,
  `product_variant_price` double DEFAULT NULL,
  `product_variant_image` mediumtext,
...
LOCK TABLES `product_variant` WRITE;
/*!40000 ALTER TABLE `product_variant` DISABLE KEYS */;
INSERT INTO `product_variant` VALUES (1,1,'shirtabc0011',1,'size S',0,'',500000,'','',1),(2,1,'shirtabc0012',1,'size M',0,'',520000,'','medium size is more expensive',1),(3,1,'shirtabc0013',1,'size L',2,'black',600000,'','',1),(4,1,'shirtabc0014',1,'size XL',2,'white',630000,'','white is more expensive',1),(5,2,'shoexyz0011',2,'red',650000,'',0,'/images/products/variants/2_variant_1.jpg','red is special',1),(6,2,'shirtabc0012',2,'blue',660000,'',0,'/images/products/variants/2_variant_2.jpg ','blue is special',1),(7,2,'shirtabc0013',2,'green',670000,'',0,'/images/products/variants/2_variant_3.jpg ','green is special',1),(8,2,'shirtabc0014',2,'yellow',680000,'',0,'/images/products/variants/2_variant_4.jpg ','yello is special',1);
/*!40000 ALTER TABLE `product_variant` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-12-26 10:34:02
-- MySQL dump 10.13  Distrib 5.5.46, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: web1_asiantech
-- ------------------------------------------------------
...
-- Dump completed on 2015-12-27 14:27:21
-- MySQL dump 10.13  Distrib 5.5.46, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: web_asiantech
-- ------------------------------------------------------
-- Server version	5.5.46-0ubuntu0.14.04.2
...
LOCK TABLES `city` WRITE;
/*!40000 ALTER TABLE `city` DISABLE KEYS */;
INSERT INTO `city` VALUES (1,1,'Ho Chi Minh',1),(2,1,'Ha Noi',1),(3,1,'Da Nang',1),(4,2,'New York',1),(5,2,'Houston',1),(6,3,'Bangkok',1),(7,3,'Pattya',1),(8,4,'Singapore',1);
/*!40000 ALTER TABLE `city` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `customer` WRITE;
/*!40000 ALTER TABLE `customer` DISABLE KEYS */;
INSERT INTO `customer` VALUES (1,'Dat Huynh','dathuynh@asiantechhub.com','0937111811','827ccb0eea8a706c4c34a16891f84e7b','0000-00-00',3,1),(2,'Tai Pham','taipham@asiantechhub.com','0937111811','123456','0000-00-00',2,1),(3,'Tu Vuong','tuvuong@asiantechhub.com','0937111811','','0000-00-00',1,1),(4,'Dat Huynh','dat.huynh@huynhgiatien.com','1111111111','827ccb0eea8a706c4c34a16891f84e7b','2016-01-16',2,1),(5,NULL,NULL,NULL,NULL,'2016-01-17',1,1);
/*!40000 ALTER TABLE `customer` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `customer_detail` WRITE;
/*!40000 ALTER TABLE `customer_detail` DISABLE KEYS */;
INSERT INTO `customer_detail` VALUES (1,1,1,0,0,'0000-00-12','','','',''),(2,2,1,0,0,'0000-00-00','','','','');
/*!40000 ALTER TABLE `customer_detail` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `district` WRITE;
/*!40000 ALTER TABLE `district` DISABLE KEYS */;
INSERT INTO `district` VALUES (1,1,'Quan 1',1),(2,1,'Quan 2',1),(3,1,'Quan 3',1),(4,2,'Hoan Kiem',1),(5,2,'Hang Da',1),(6,3,'Hai Chau',1),(7,4,'Manhattan',1),(8,5,'Orange County',1),(9,6,'Bang Bon',1),(10,6,'Bang Noi',1),(11,7,'Pattaya',1),(12,8,'Changi',1),(13,8,'China Town',1);
/*!40000 ALTER TABLE `district` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `master_category` WRITE;
/*!40000 ALTER TABLE `master_category` DISABLE KEYS */;
INSERT INTO `master_category` VALUES (1,'Man','Products for man','application/views/images/categories/men_bg.jpg',1),(2,'Woman','Products for woman','application/views/images/categories/women_bg.jpg',1);
/*!40000 ALTER TABLE `master_category` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `order_extra_fee_detail` WRITE;
/*!40000 ALTER TABLE `order_extra_fee_detail` DISABLE KEYS */;
INSERT INTO `order_extra_fee_detail` VALUES (1,7,NULL,0),(2,8,NULL,0),(3,9,NULL,0);
/*!40000 ALTER TABLE `order_extra_fee_detail` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `order_item` WRITE;
/*!40000 ALTER TABLE `order_item` DISABLE KEYS */;
INSERT INTO `order_item` VALUES (1,1,1,1,500000,500000,0,1,'deliver soon',1),(2,1,1,2,500000,500000,0,1,'deliver soon',3),(3,1,1,2,500000,500000,0,1,'deliver soon',3),(4,1,1,4,500000,500000,0,1,'deliver soon',3),(5,1,3,0,500000,500000,0,1,'deliver soon',3),(6,2,1,3,500000,500000,0,1,'deliver soon',3),(7,2,1,4,500000,500000,0,1,'deliver soon',3),(8,2,4,0,500000,500000,0,1,'deliver soon',2),(9,3,1,5,500000,500000,0,1,'deliver soon',3),(10,3,1,5,500000,500000,0,1,'deliver soon',2),(11,3,5,0,500000,500000,0,1,'deliver soon',4),(12,4,6,0,500000,500000,0,1,'deliver soon',1),(13,5,7,0,500000,500000,0,1,'deliver soon',1),(14,6,3,0,500000,500000,0,1,'deliver soon',3),(15,7,1,NULL,500000,NULL,NULL,1,NULL,1),(16,7,1,NULL,500000,NULL,NULL,2,NULL,1),(17,8,1,NULL,500000,NULL,NULL,1,NULL,1),(18,9,1,NULL,500000,NULL,NULL,1,NULL,1);
/*!40000 ALTER TABLE `order_item` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `order_payment` WRITE;
/*!40000 ALTER TABLE `order_payment` DISABLE KEYS */;
INSERT INTO `order_payment` VALUES (1,7,NULL,'2016-01-17 14:55:52',NULL,1500000,0),(2,8,NULL,'2016-01-17 15:08:44',NULL,500000,0),(3,9,NULL,'2016-01-17 16:22:40',NULL,500000,0);
/*!40000 ALTER TABLE `order_payment` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `orders` WRITE;
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
INSERT INTO `orders` VALUES (1,'0000-00-00',1,'this is note','Dat Huynh','0937111811','14 phan ton','1','1','1',1,'TR123456','0000-00-00','0000-00-00','0000-00-00',20000,1,6,NULL),(2,'0000-00-00',2,'this is note','Tu Vuong','0937111811','15 phan ton','1','1','1',1,'TR123456','0000-00-00','0000-00-00','0000-00-00',30000,1,1,NULL),(3,'0000-00-00',3,'this is note','Tai Pham','0937111811','15 phan ton','1','1','1',1,'TR123456','0000-00-00','0000-00-00','0000-00-00',30000,1,1,NULL),(4,'0000-00-00',2,'this is note','Tu Vuong','0937111811','15 phan ton','1','1','1',1,'TR123456','0000-00-00','0000-00-00','0000-00-00',30000,1,6,NULL),(5,'0000-00-00',2,'this is note','Tu Vuong','0937111811','15 phan ton','1','1','1',1,'TR123456','0000-00-00','0000-00-00','0000-00-00',30000,1,6,NULL),(6,'0000-00-00',2,'this is note','Tu Vuong','0937111811','15 phan ton','1','1','1',1,'TR123456','0000-00-00','0000-00-00','0000-00-00',30000,1,6,NULL),(7,'2016-01-17',1,NULL,'Dat Huynh','0937111811','14 Phan Ton','Viet Nam','','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL),(8,'2016-01-17',5,NULL,'tu','01652679144','76/26 NTG','1','1','1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL),(9,'2016-01-17',1,NULL,'Dat hUynh','0937111811','14 Phan Ton','Viet Nam','Ho Chi Minh','Quan 1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL);
/*!40000 ALTER TABLE `orders` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `product_image` WRITE;
/*!40000 ALTER TABLE `product_image` DISABLE KEYS */;
INSERT INTO `product_image` VALUES (1,1,'prod1_1','1','jpg','200','/images/products/main','',1),(2,1,'prod1_1','2','jpg','200','/images/products/main','',1),(3,1,'prod1_2','3','jpg','200','/images/products/main','',1),(4,2,'prod2_1','1','jpg','200','/images/products/main','',1),(5,2,'prod2_2','2','jpg','200','/images/products/main','',1),(6,2,'prod2_3','3','jpg','200','/images/products/main','',1),(7,3,'prod3_1','1','jpg','200','/images/products/main','',1),(8,4,'prod4_1','1','jpg','200','/images/products/main','',1),(9,5,'prod5_1','1','jpg','200','/images/products/main','',1),(10,6,'prod6_1','1','jpg','200','/images/products/main','',1),(11,7,'prod7_1','1','jpg','200','/images/products/main','',1),(12,8,'prod8_1','1','jpg','200','/images/products/main','',1),(13,9,'prod9_1','1','jpg','200','/images/products/main','',1),(14,10,'prod10_1','1','jpg','200','/images/products/main','',1),(15,11,'prod11_1','1','jpg','200','/images/products/main','',1),(16,12,'prod12_1','1','jpg','200','/images/products/main','',1),(17,13,'prod13_1','1','jpg','200','/images/products/main','',1),(18,14,'prod14_1','1','jpg','200','/images/products/main','',1),(19,15,'prod15_1','1','jpg','200','/images/products/main','',1),(20,16,'prod16_1','1','jpg','200','/images/products/main','',1),(21,17,'prod17_1','1','jpg','200','/images/products/main','',1),(22,18,'prod18_1','1','jpg','200','/images/products/main','',1),(23,19,'prod19_1','1','jpg','200','/images/products/main','',1),(24,20,'prod20_1','1','jpg','200','/images/products/main','',1),(25,21,'prod21_1','1','jpg','200','/images/products/main','',1);
/*!40000 ALTER TABLE `product_image` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `product_image_type`
--
...
CREATE TABLE `product_image_type` (
  `prod_image_type_id` int(11) NOT NULL AUTO_INCREMENT,
  `prod_image_name` varchar(200) DEFAULT NULL,
  `prod_image_require` tinyint(4) DEFAULT NULL,
  `payment_status_status` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`prod_image_type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `product_image_type`
--

LOCK TABLES `product_image_type` WRITE;
/*!40000 ALTER TABLE `product_image_type` DISABLE KEYS */;
INSERT INTO `product_image_type` VALUES (1,'default',1,1),(2,'front',1,1),(3,'back',0,1),(4,'side',0,1);
/*!40000 ALTER TABLE `product_image_type` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `product_type` WRITE;
/*!40000 ALTER TABLE `product_type` DISABLE KEYS */;
INSERT INTO `product_type` VALUES (1,'Best Seller',1),(2,'Hot Product',1),(3,'New Arrival',1);
/*!40000 ALTER TABLE `product_type` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `promotion` WRITE;
/*!40000 ALTER TABLE `promotion` DISABLE KEYS */;
INSERT INTO `promotion` VALUES (1,'new year discount','2016-01-01','2016-06-30',1,1);
/*!40000 ALTER TABLE `promotion` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `promotion_detail` (
  `promotion_detail_id` int(11) NOT NULL AUTO_INCREMENT,
  `promotion_id` int(11) DEFAULT NULL,
  `promotion_detail_field` tinyint(4) DEFAULT NULL,
  `promotion_detail_mapping_field_valueint` int(11) DEFAULT NULL,
  `promotion_detail_mapping_field_valuedouble` double DEFAULT NULL,
  `promotion_detail_mapping_field_valuedate` date DEFAULT NULL,
  `promotion_detail_mapping_field_shortchar` varchar(50) DEFAULT NULL,
...
LOCK TABLES `promotion_detail` WRITE;
/*!40000 ALTER TABLE `promotion_detail` DISABLE KEYS */;
INSERT INTO `promotion_detail` VALUES (1,1,1,30,0,'0000-00-00','','','','');
/*!40000 ALTER TABLE `promotion_detail` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `promotion_item_mapping` WRITE;
/*!40000 ALTER TABLE `promotion_item_mapping` DISABLE KEYS */;
INSERT INTO `promotion_item_mapping` VALUES (1,1,1,1),(2,1,3,1),(3,1,4,1),(4,1,5,1),(5,1,6,1),(6,1,7,1);
/*!40000 ALTER TABLE `promotion_item_mapping` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `promotion_type_mapping` WRITE;
/*!40000 ALTER TABLE `promotion_type_mapping` DISABLE KEYS */;
INSERT INTO `promotion_type_mapping` VALUES (1,1,1,1);
/*!40000 ALTER TABLE `promotion_type_mapping` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-01-17 21:25:22
